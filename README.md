# Databricks Industry Data Models

Forty production-ready industry data models, each shipped in two flavours (ECM + MVM) — auto-generated by an LLM-powered pipeline that turns a one-paragraph business description into a Unity-Catalog-ready model with schemas, foreign keys, sample data, metric views, ontology tags, and DBML diagrams.
