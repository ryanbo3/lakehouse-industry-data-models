-- Schema for Domain: reference | Business: Healthcare | Version: v1_ecm
...
CREATE OR REPLACE TABLE `healthcare_ecm`.`reference`.`ndc_drug` (
    ...
    `snomed_ct_code` STRING COMMENT 'The SNOMED CT concept code representing the drug product or substance for clinical documentation and interoperability.',
...
CREATE OR REPLACE TABLE `healthcare_ecm`.`reference`.`fhir_value_set` (
...
CREATE OR REPLACE TABLE `healthcare_ecm`.`reference`.`geographic_region` (
...
CREATE OR REPLACE TABLE `healthcare_ecm`.`reference`.`condition_code` (
...
CREATE OR REPLACE TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` (
...
ALTER TABLE `healthcare_ecm`.`reference`.`drg` ADD CONSTRAINT `fk_reference_drg_major_diagnostic_category_id` FOREIGN KEY (`major_diagnostic_category_id`) REFERENCES `healthcare_ecm`.`reference`.`major_diagnostic_category`(`major_diagnostic_category_id`);
...
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ADD CONSTRAINT `fk_reference_fhir_value_set_code_set_version_id` FOREIGN KEY (`code_set_version_id`) REFERENCES `healthcare_ecm`.`reference`.`code_set_version`(`code_set_version_id`);
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` ADD CONSTRAINT `fk_reference_npi_registry_geographic_region_id` FOREIGN KEY (`geographic_region_id`) REFERENCES `healthcare_ecm`.`reference`.`geographic_region`(`geographic_region_id`);
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ADD CONSTRAINT `fk_reference_geographic_region_parent_region_geographic_region_id` FOREIGN KEY (`parent_region_geographic_region_id`) REFERENCES `healthcare_ecm`.`reference`.`geographic_region`(`geographic_region_id`);
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ADD CONSTRAINT `fk_reference_condition_code_code_set_version_id` FOREIGN KEY (`code_set_version_id`) REFERENCES `healthcare_ecm`.`reference`.`code_set_version`(`code_set_version_id`);
...
ALTER TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` ADD CONSTRAINT `fk_reference_major_diagnostic_category_parent_major_diagnostic_category_id` FOREIGN KEY (`parent_major_diagnostic_category_id`) REFERENCES `healthcare_ecm`.`reference`.`major_diagnostic_category`(`major_diagnostic_category_id`);
...
ALTER TABLE `healthcare_ecm`.`reference`.`icd_code` SET TAGS ('dbx_subdomain' = 'clinical_terminology');
...
ALTER TABLE `healthcare_ecm`.`reference`.`icd_code` ALTER COLUMN `parent_code` SET TAGS ('dbx_business_glossary_term' = 'Parent ICD (International Classification of Diseases) Code');
...
ALTER TABLE `healthcare_ecm`.`reference`.`cpt_code` SET TAGS ('dbx_subdomain' = 'billing_codes');
...
ALTER TABLE `healthcare_ecm`.`reference`.`hcpcs_code` SET TAGS ('dbx_subdomain' = 'billing_codes');
...
ALTER TABLE `healthcare_ecm`.`reference`.`hcpcs_code` ALTER COLUMN `superseded_by_code` SET TAGS ('dbx_business_glossary_term' = 'Superseded By HCPCS (Healthcare Common Procedure Coding System) Code');
...
ALTER TABLE `healthcare_ecm`.`reference`.`drg` SET TAGS ('dbx_subdomain' = 'billing_codes');
...
ALTER TABLE `healthcare_ecm`.`reference`.`drg` ALTER COLUMN `major_diagnostic_category_id` SET TAGS ('dbx_business_glossary_term' = 'Major Diagnostic Category (MDC) Identifier');
...
ALTER TABLE `healthcare_ecm`.`reference`.`snomed_concept` SET TAGS ('dbx_subdomain' = 'clinical_terminology');
...
ALTER TABLE `healthcare_ecm`.`reference`.`loinc_code` SET TAGS ('dbx_subdomain' = 'clinical_terminology');
...
ALTER TABLE `healthcare_ecm`.`reference`.`loinc_code` ALTER COLUMN `related_names` SET TAGS ('dbx_business_glossary_term' = 'Related Names');
...
ALTER TABLE `healthcare_ecm`.`reference`.`ndc_drug` SET TAGS ('dbx_subdomain' = 'clinical_terminology');
...
ALTER TABLE `healthcare_ecm`.`reference`.`ndc_drug` ALTER COLUMN `snomed_ct_code` SET TAGS ('dbx_business_glossary_term' = 'Systematized Nomenclature of Medicine Clinical Terms (SNOMED CT) Code');
...
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` SET TAGS ('dbx_subdomain' = 'clinical_terminology');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `fhir_value_set_id` SET TAGS ('dbx_business_glossary_term' = 'Fast Healthcare Interoperability Resources (FHIR) Value Set Identifier');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `code_set_version_id` SET TAGS ('dbx_business_glossary_term' = 'Code Set Version Id (Foreign Key)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `binding_strength` SET TAGS ('dbx_business_glossary_term' = 'Binding Strength');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `binding_strength` SET TAGS ('dbx_value_regex' = 'required|extensible|preferred|example');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `canonical_url` SET TAGS ('dbx_business_glossary_term' = 'Canonical Uniform Resource Locator (URL)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `canonical_url` SET TAGS ('dbx_value_regex' = '^https?://[a-zA-Z0-9.-]+(/[a-zA-Z0-9._~:/?#[]@!$&()*+,;=-]*)?$');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `compose_exclude_count` SET TAGS ('dbx_business_glossary_term' = 'Compose Exclude Count');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `compose_include_count` SET TAGS ('dbx_business_glossary_term' = 'Compose Include Count');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `contact_json` SET TAGS ('dbx_business_glossary_term' = 'Contact Information JavaScript Object Notation (JSON)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `copyright` SET TAGS ('dbx_business_glossary_term' = 'Copyright Notice');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `expansion_identifier` SET TAGS ('dbx_business_glossary_term' = 'Expansion Identifier');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `expansion_offset` SET TAGS ('dbx_business_glossary_term' = 'Expansion Offset');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `expansion_parameter_json` SET TAGS ('dbx_business_glossary_term' = 'Expansion Parameter JavaScript Object Notation (JSON)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `expansion_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Expansion Timestamp');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `expansion_total_concepts` SET TAGS ('dbx_business_glossary_term' = 'Expansion Total Concepts');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `experimental_flag` SET TAGS ('dbx_business_glossary_term' = 'Experimental Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `fhir_element_path` SET TAGS ('dbx_business_glossary_term' = 'Fast Healthcare Interoperability Resources (FHIR) Element Path');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `fhir_resource_type` SET TAGS ('dbx_business_glossary_term' = 'Fast Healthcare Interoperability Resources (FHIR) Resource Type');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `fhir_value_set_description` SET TAGS ('dbx_business_glossary_term' = 'Value Set Description');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `immutable_flag` SET TAGS ('dbx_business_glossary_term' = 'Immutable Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `jurisdiction_codes` SET TAGS ('dbx_business_glossary_term' = 'Jurisdiction Codes');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `last_review_date` SET TAGS ('dbx_business_glossary_term' = 'Last Review Date');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `publisher` SET TAGS ('dbx_business_glossary_term' = 'Publisher Organization');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `purpose` SET TAGS ('dbx_business_glossary_term' = 'Value Set Purpose');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `title` SET TAGS ('dbx_business_glossary_term' = 'Value Set Title');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `use_context_json` SET TAGS ('dbx_business_glossary_term' = 'Use Context JavaScript Object Notation (JSON)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `value_set_name` SET TAGS ('dbx_business_glossary_term' = 'Value Set Name');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `value_set_oid` SET TAGS ('dbx_business_glossary_term' = 'Object Identifier (OID)');
ALTER TABLE `healthcare_ecm`.`reference`.`fhir_value_set` ALTER COLUMN `value_set_oid` SET TAGS ('dbx_value_regex' = '^[0-2](.(0|[1-9][0-9]*))+$');
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` SET TAGS ('dbx_subdomain' = 'provider_geography');
...
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` ALTER COLUMN `geographic_region_id` SET TAGS ('dbx_business_glossary_term' = 'Practice Location Geographic Region Id (Foreign Key)');
...
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` ALTER COLUMN `replacement_npi` SET TAGS ('dbx_business_glossary_term' = 'Replacement National Provider Identifier (NPI)');
ALTER TABLE `healthcare_ecm`.`reference`.`npi_registry` ALTER COLUMN `replacement_npi` SET TAGS ('dbx_value_regex' = '^[0-9]{10}$');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` SET TAGS ('dbx_subdomain' = 'provider_geography');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `geographic_region_id` SET TAGS ('dbx_business_glossary_term' = 'Geographic Region Identifier (ID)');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `parent_region_geographic_region_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Region Identifier (ID)');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `aco_service_area_flag` SET TAGS ('dbx_business_glossary_term' = 'Accountable Care Organization (ACO) Service Area Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `cbsa_code` SET TAGS ('dbx_business_glossary_term' = 'Core-Based Statistical Area (CBSA) Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `cbsa_name` SET TAGS ('dbx_business_glossary_term' = 'Core-Based Statistical Area (CBSA) Name');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `census_division` SET TAGS ('dbx_business_glossary_term' = 'Census Division');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `census_region` SET TAGS ('dbx_business_glossary_term' = 'Census Region');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `census_region` SET TAGS ('dbx_value_regex' = 'northeast|midwest|south|west');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `cms_region_number` SET TAGS ('dbx_business_glossary_term' = 'Centers for Medicare and Medicaid Services (CMS) Region Number');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `country_code` SET TAGS ('dbx_business_glossary_term' = 'Country Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `fips_code` SET TAGS ('dbx_business_glossary_term' = 'Federal Information Processing Standards (FIPS) Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `hrr_code` SET TAGS ('dbx_business_glossary_term' = 'Hospital Referral Region (HRR) Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `hsa_code` SET TAGS ('dbx_business_glossary_term' = 'Hospital Service Area (HSA) Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Active Status Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `latitude` SET TAGS ('dbx_business_glossary_term' = 'Latitude');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `longitude` SET TAGS ('dbx_business_glossary_term' = 'Longitude');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `median_household_income` SET TAGS ('dbx_business_glossary_term' = 'Median Household Income');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `population_estimate` SET TAGS ('dbx_business_glossary_term' = 'Population Estimate');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `poverty_rate_percent` SET TAGS ('dbx_business_glossary_term' = 'Poverty Rate Percentage');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `region_code` SET TAGS ('dbx_business_glossary_term' = 'Region Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `region_name` SET TAGS ('dbx_business_glossary_term' = 'Region Name');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `region_type` SET TAGS ('dbx_business_glossary_term' = 'Region Type');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `ruca_code` SET TAGS ('dbx_business_glossary_term' = 'Rural-Urban Commuting Area (RUCA) Code');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `source_system` SET TAGS ('dbx_business_glossary_term' = 'Source System');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `state_abbreviation` SET TAGS ('dbx_business_glossary_term' = 'State Abbreviation');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `time_zone` SET TAGS ('dbx_business_glossary_term' = 'Time Zone');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `uninsured_rate_percent` SET TAGS ('dbx_business_glossary_term' = 'Uninsured Rate Percentage');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `urban_rural_classification` SET TAGS ('dbx_business_glossary_term' = 'Urban-Rural Classification');
ALTER TABLE `healthcare_ecm`.`reference`.`geographic_region` ALTER COLUMN `urban_rural_classification` SET TAGS ('dbx_value_regex' = 'urban|suburban|rural|frontier');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` SET TAGS ('dbx_subdomain' = 'billing_codes');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `condition_code_id` SET TAGS ('dbx_business_glossary_term' = 'Condition Code ID');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `code_set_version_id` SET TAGS ('dbx_business_glossary_term' = 'Code Set Version Id (Foreign Key)');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `ama_indicator` SET TAGS ('dbx_business_glossary_term' = 'Against Medical Advice (AMA) Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `bilateral_indicator` SET TAGS ('dbx_business_glossary_term' = 'Bilateral Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `claim_form_type` SET TAGS ('dbx_business_glossary_term' = 'Claim Form Type');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `claim_form_type` SET TAGS ('dbx_value_regex' = 'UB-04|CMS-1500|BOTH');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `code_type` SET TAGS ('dbx_business_glossary_term' = 'Code Type');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `commercial_payer_flag` SET TAGS ('dbx_business_glossary_term' = 'Commercial Payer Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `condition_code_category` SET TAGS ('dbx_business_glossary_term' = 'Code Category');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `condition_code_code` SET TAGS ('dbx_business_glossary_term' = 'Code Value');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `condition_code_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{1,5}$');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `condition_code_description` SET TAGS ('dbx_business_glossary_term' = 'Code Description');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `expired_indicator` SET TAGS ('dbx_business_glossary_term' = 'Expired Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `facility_indicator` SET TAGS ('dbx_business_glossary_term' = 'Facility Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `governing_body` SET TAGS ('dbx_business_glossary_term' = 'Governing Body');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `governing_body` SET TAGS ('dbx_value_regex' = 'NUBC|CMS|AMA|STATE');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `hospice_indicator` SET TAGS ('dbx_business_glossary_term' = 'Hospice Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `last_updated_date` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Date');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `medicaid_approved_flag` SET TAGS ('dbx_business_glossary_term' = 'Medicaid Approved Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `medicare_approved_flag` SET TAGS ('dbx_business_glossary_term' = 'Medicare Approved Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `pricing_impact_flag` SET TAGS ('dbx_business_glossary_term' = 'Pricing Impact Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `professional_indicator` SET TAGS ('dbx_business_glossary_term' = 'Professional Indicator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `replacement_code` SET TAGS ('dbx_business_glossary_term' = 'Replacement Code');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `requires_value_flag` SET TAGS ('dbx_business_glossary_term' = 'Requires Value Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `short_description` SET TAGS ('dbx_business_glossary_term' = 'Short Description');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `source_system` SET TAGS ('dbx_business_glossary_term' = 'Source System');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `telehealth_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Telehealth Eligible Flag');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `termination_date` SET TAGS ('dbx_business_glossary_term' = 'Termination Date');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `ub04_form_locator` SET TAGS ('dbx_business_glossary_term' = 'UB-04 Form Locator');
ALTER TABLE `healthcare_ecm`.`reference`.`condition_code` ALTER COLUMN `usage_notes` SET TAGS ('dbx_business_glossary_term' = 'Usage Notes');
ALTER TABLE `healthcare_ecm`.`reference`.`code_set_version` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `healthcare_ecm`.`reference`.`code_set_version` SET TAGS ('dbx_subdomain' = 'metadata_management');
...
ALTER TABLE `healthcare_ecm`.`reference`.`crosswalk` SET TAGS ('dbx_subdomain' = 'metadata_management');
...
ALTER TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` SET TAGS ('dbx_subdomain' = 'billing_codes');
ALTER TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` ALTER COLUMN `major_diagnostic_category_id` SET TAGS ('dbx_business_glossary_term' = 'Major Diagnostic Category Identifier');
ALTER TABLE `healthcare_ecm`.`reference`.`major_diagnostic_category` ALTER COLUMN `parent_major_diagnostic_category_id` SET TAGS ('dbx_self_ref_fk' = 'true');
