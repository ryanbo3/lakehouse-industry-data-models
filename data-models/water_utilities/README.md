...
Part of **Databricks Industry Data Models**. Two model flavours are available for Water Utilities, each a Unity-Catalog-ready data model with schemas, foreign keys, sample data, metric views, ontology tags, and DBML diagrams.
