...
See [`mvm_v1/readme.md`](mvm_v1/readme.md) for the full per-domain detail.
...
See [`ecm_v1/readme.md`](ecm_v1/readme.md) for the full per-domain detail.
...
> **Note:** This top-level readme was synthesized from volume artifacts after the agent's workspace writeback step did not run for this industry. The per-version `ecm_v1/readme.md` and `mvm_v1/readme.md` are the agent's full original output.
