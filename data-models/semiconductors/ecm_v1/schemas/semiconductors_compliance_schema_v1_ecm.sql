-- Schema for Domain: compliance | Business: Semiconductors | Version: v1_ecm
-- Generated on: 2026-05-06 18:26:00
...
CREATE OR REPLACE TABLE `semiconductors_ecm`.`compliance`.`audit_event` (
    `audit_event_id` BIGINT COMMENT 'Unique system-generated identifier for the audit event record.',
    `employee_id` BIGINT COMMENT 'Foreign key linking to workforce.employee. Business justification: Audit Management assigns a lead auditor employee to each audit for accountability and reporting.',
...
CREATE OR REPLACE TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` (
    ...
    `compliance_audit_event_id` BIGINT COMMENT 'Identifier of the audit or inspection event that generated this finding.',
...
CREATE OR REPLACE TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` (
    ...
    `regulatory_chips_act_obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.chips_act_obligation. Business justification: Regulatory filing often satisfies a specific CHIPS Act obligation; linking provides traceability.',
    `related_filing_regulatory_filing_id` BIGINT COMMENT 'Identifier of a related filing (e.g., amendment).',
    `employee_id` BIGINT COMMENT 'Foreign key linking to workforce.employee. Business justification: Regulatory filing system records which employee submitted the filing for traceability.',
...
CREATE OR REPLACE TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` (
    ...
    `employee_id` BIGINT COMMENT 'Foreign key linking to workforce.employee. Business justification: Technology Control Plans list employees authorized to access controlled technology for security compliance.',
    ...
    `technology_eccn_classification_id` BIGINT COMMENT 'Foreign key linking to compliance.eccn_classification. Business justification: Technology control plan references an ECCN; FK avoids duplication of ECCN data.',
...
CREATE OR REPLACE TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` (
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` ADD CONSTRAINT `fk_compliance_export_license_usage_to_export_license` FOREIGN KEY (`to_export_license`) REFERENCES `semiconductors_ecm`.`compliance`.`export_license`(`export_license_id`);
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ADD CONSTRAINT `fk_compliance_compliance_audit_finding_audit_event_id` FOREIGN KEY (`audit_event_id`) REFERENCES `semiconductors_ecm`.`compliance`.`audit_event`(`audit_event_id`);
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ADD CONSTRAINT `fk_compliance_compliance_audit_finding_compliance_audit_event_id` FOREIGN KEY (`compliance_audit_event_id`) REFERENCES `semiconductors_ecm`.`compliance`.`audit_event`(`audit_event_id`);
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ADD CONSTRAINT `fk_compliance_regulatory_filing_related_filing_regulatory_filing_id` FOREIGN KEY (`related_filing_regulatory_filing_id`) REFERENCES `semiconductors_ecm`.`compliance`.`regulatory_filing`(`regulatory_filing_id`);
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ADD CONSTRAINT `fk_compliance_declaration_substance_reach_svhc_declaration_id` FOREIGN KEY (`reach_svhc_declaration_id`) REFERENCES `semiconductors_ecm`.`compliance`.`reach_svhc_declaration`(`reach_svhc_declaration_id`);
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ADD CONSTRAINT `fk_compliance_declaration_substance_substance_inventory_id` FOREIGN KEY (`substance_inventory_id`) REFERENCES `semiconductors_ecm`.`compliance`.`substance_inventory`(`substance_inventory_id`);
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Empowered Official Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`export_license_usage` ALTER COLUMN `shipment_reference` SET TAGS ('dbx_business_glossary_term' = 'Shipment Reference');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`eccn_classification` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`restricted_party_screening` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`restricted_party_screening` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Analyst ID');
ALTER TABLE `semiconductors_ecm`.`compliance`.`restricted_party_screening` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`restricted_party_screening` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` SET TAGS ('dbx_subdomain' = 'substance_management');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Signatory Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `related_product_family` SET TAGS ('dbx_business_glossary_term' = 'Related Product Family');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `substance_cas_number` SET TAGS ('dbx_business_glossary_term' = 'Substance CAS Number');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `substance_cas_number` SET TAGS ('dbx_value_regex' = '^d{2,7}-d{2}-d$');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `substance_category` SET TAGS ('dbx_business_glossary_term' = 'Substance Category');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `substance_category` SET TAGS ('dbx_value_regex' = 'rohs|reach|tsca|prop65|halogen');
ALTER TABLE `semiconductors_ecm`.`compliance`.`reach_svhc_declaration` ALTER COLUMN `substance_name` SET TAGS ('dbx_business_glossary_term' = 'Substance Name');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`substance_inventory` SET TAGS ('dbx_subdomain' = 'substance_management');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`certification` SET TAGS ('dbx_subdomain' = 'audit_governance');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`certification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Certification Holder Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`certification` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`certification` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`certification` ALTER COLUMN `related_regulation_codes` SET TAGS ('dbx_business_glossary_term' = 'Related Regulation Codes');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_event_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Event Identifier');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Lead Auditor Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_category` SET TAGS ('dbx_business_glossary_term' = 'Audit Category');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_category` SET TAGS ('dbx_value_regex' = 'process|product|system|supplier|environmental');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_conducted_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Audit Conducted Timestamp');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_end_date` SET TAGS ('dbx_business_glossary_term' = 'Audit End Date');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_language` SET TAGS ('dbx_business_glossary_term' = 'Audit Language');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_notes` SET TAGS ('dbx_business_glossary_term' = 'Audit Notes');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_number` SET TAGS ('dbx_business_glossary_term' = 'Audit Number (AUD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_number` SET TAGS ('dbx_value_regex' = '^AUD-[0-9]{6}$');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_region` SET TAGS ('dbx_business_glossary_term' = 'Audit Region (ISO Country Code)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_region` SET TAGS ('dbx_value_regex' = 'USA|CHN|KOR|JPN|DEU|TWN');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_scope` SET TAGS ('dbx_business_glossary_term' = 'Audit Scope');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_standard` SET TAGS ('dbx_business_glossary_term' = 'Audit Standard (ISO/ITAR/EAR/etc.)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_standard` SET TAGS ('dbx_value_regex' = 'iso_9001|iattf_16949|itar|ear|rba_eicc|semiconductor_semi');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_start_date` SET TAGS ('dbx_business_glossary_term' = 'Audit Start Date');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_type` SET TAGS ('dbx_business_glossary_term' = 'Audit Type');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_type` SET TAGS ('dbx_value_regex' = 'internal|customer|third_party|regulatory');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `audit_version` SET TAGS ('dbx_business_glossary_term' = 'Audit Version');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `auditing_body` SET TAGS ('dbx_business_glossary_term' = 'Auditing Body');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `closure_status` SET TAGS ('dbx_business_glossary_term' = 'Audit Closure Status');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `closure_status` SET TAGS ('dbx_value_regex' = 'open|closed|in_progress');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `corrective_action_due_date` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Due Date');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `corrective_action_plan_summary` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan Summary');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Audit Documentation URL');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `findings_summary` SET TAGS ('dbx_business_glossary_term' = 'Findings Summary');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_business_glossary_term' = 'Audit Lifecycle Status');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_value_regex' = 'planned|in_progress|completed|closed');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `major_findings_count` SET TAGS ('dbx_business_glossary_term' = 'Major Findings Count');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `minor_findings_count` SET TAGS ('dbx_business_glossary_term' = 'Minor Findings Count');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `overall_result` SET TAGS ('dbx_business_glossary_term' = 'Overall Audit Result');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `overall_result` SET TAGS ('dbx_value_regex' = 'pass|conditional_pass|fail');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `record_audit_created` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `record_audit_updated` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Audit Risk Level');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `site_audited` SET TAGS ('dbx_business_glossary_term' = 'Site Audited');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `site_audited` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`audit_event` ALTER COLUMN `site_audited` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `compliance_audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Audit Finding Identifier');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `compliance_audit_event_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Event Identifier (AEID)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Owner Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `actual_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Completion Date (ACD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `clause_violated` SET TAGS ('dbx_business_glossary_term' = 'Violated Clause Identifier (VCI)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `compliance_audit_finding_description` SET TAGS ('dbx_business_glossary_term' = 'Finding Description (FD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `compliance_audit_finding_status` SET TAGS ('dbx_business_glossary_term' = 'Finding Status (FS)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `compliance_audit_finding_status` SET TAGS ('dbx_value_regex' = 'open|in_progress|closed|rejected');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `corrective_action_plan` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan (CAP)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (RCT)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `effectiveness_verification_date` SET TAGS ('dbx_business_glossary_term' = 'Effectiveness Verification Date (EVD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `effectiveness_verification_method` SET TAGS ('dbx_business_glossary_term' = 'Effectiveness Verification Method (EVM)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `finding_reference` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Reference Code (AFR)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `finding_type` SET TAGS ('dbx_business_glossary_term' = 'Finding Type (FT)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `finding_type` SET TAGS ('dbx_value_regex' = 'major|minor|observation|opportunity');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `identified_by` SET TAGS ('dbx_business_glossary_term' = 'Identified By (IB)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `identified_by` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `identified_by` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `preventive_action_plan` SET TAGS ('dbx_business_glossary_term' = 'Preventive Action Plan (PAP)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference (RR)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `risk_rating` SET TAGS ('dbx_business_glossary_term' = 'Risk Rating (RR)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `risk_rating` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `root_cause_description` SET TAGS ('dbx_business_glossary_term' = 'Root Cause Description (RCD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `root_cause_method` SET TAGS ('dbx_business_glossary_term' = 'Root Cause Analysis Method (RCAM)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `root_cause_method` SET TAGS ('dbx_value_regex' = '5-why|ishikawa|8d|fishbone');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `severity_score` SET TAGS ('dbx_business_glossary_term' = 'Severity Score (SS)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `target_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Target Completion Date (TCD)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`compliance_audit_finding` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (RUT)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` SET TAGS ('dbx_subdomain' = 'audit_governance');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `regulatory_chips_act_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Chips Act Obligation Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `related_filing_regulatory_filing_id` SET TAGS ('dbx_business_glossary_term' = 'Related Filing ID');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submitter Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`regulatory_filing` ALTER COLUMN `test_program_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Id (Foreign Key)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`chips_act_obligation` SET TAGS ('dbx_subdomain' = 'audit_governance');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`conflict_minerals_declaration` SET TAGS ('dbx_subdomain' = 'substance_management');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Hold Placed By Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` ALTER COLUMN `commodity_eccn` SET TAGS ('dbx_business_glossary_term' = 'Export Control Classification Number (ECCN)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`trade_compliance_hold` ALTER COLUMN `related_party_reference` SET TAGS ('dbx_business_glossary_term' = 'Related Party Identifier (RPI)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`obligation_register` SET TAGS ('dbx_subdomain' = 'audit_governance');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`obligation_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Control Owner Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`obligation_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`obligation_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`obligation_register` ALTER COLUMN `chips_act_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Chips Act Obligation Id (Foreign Key)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` SET TAGS ('dbx_subdomain' = 'export_control');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Authorized Personnel Employee Id (Foreign Key)');
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `fabrication_technology_node_id` SET TAGS ('dbx_business_glossary_term' = 'Technology Node Id (Foreign Key)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `technology_eccn_classification_id` SET TAGS ('dbx_business_glossary_term' = 'Eccn Classification Id (Foreign Key)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `license_number` SET TAGS ('dbx_business_glossary_term' = 'Export License Number');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`technology_control_plan` ALTER COLUMN `process_node` SET TAGS ('dbx_business_glossary_term' = 'Process Node (NM)');
...
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` SET TAGS ('dbx_subdomain' = 'substance_management');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` SET TAGS ('dbx_association_edges' = 'compliance.reach_svhc_declaration,compliance.substance_inventory');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ALTER COLUMN `declaration_substance_id` SET TAGS ('dbx_business_glossary_term' = 'Declaration Substance - Declaration Substance Id');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ALTER COLUMN `reach_svhc_declaration_id` SET TAGS ('dbx_business_glossary_term' = 'Declaration Substance - Reach Svhc Declaration Id');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ALTER COLUMN `substance_inventory_id` SET TAGS ('dbx_business_glossary_term' = 'Declaration Substance - Substance Inventory Id');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ALTER COLUMN `measured_concentration` SET TAGS ('dbx_business_glossary_term' = 'Measured Concentration');
ALTER TABLE `semiconductors_ecm`.`compliance`.`declaration_substance` ALTER COLUMN `threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Threshold');
